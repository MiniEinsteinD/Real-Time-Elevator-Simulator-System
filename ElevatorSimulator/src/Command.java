...
public class Command {
    ...
    public Command (String command){
        ...
        new Command(Integer.parseInt(split[0]), Integer.parseInt(split[1]),
    ...
    public String toString() {
        String string = "Command Composed Of: " + "Time: " + getTime()
                + "Floor: " + getFloor() + "Elevator Button Pressed: " +
                getElevatorButton() + "Direction: " + getDirectionButton();
        return string;
    }
}
