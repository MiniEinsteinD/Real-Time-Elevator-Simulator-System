...
public class Command {
    ...
    private Directon directionButton; //Direction enum (can be up or down)
     ...
     * @param floorButton the direction the elevator mist travel (up or down)
    ...
    public Command (String command){
        String[] split = command.split(" ");
            ...
            this.floorButton = Enum.valueOf(split[2]);
     ...
     */
    public Floor.Direction getDirectionButton(){
    ...
    public String toString() {
        String s = "";
        s = "Command Composed Of: " + "Time: " + getTime()
                + "Floor: " + getFloor() + "Elevator Button Pressed: " + getElevatorButton() + "Direction: " + getDirectionButton();
        return s;
    }
}
